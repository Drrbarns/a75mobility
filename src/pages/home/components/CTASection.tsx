      ...
      <div className="max-w-6xl mx-auto px-6 text-center relative">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto">
          {[
            ...
            <div key={index} className="group bg-white rounded-2xl p-6 shadow-lg border border-[#C9CED8]/20 hover:shadow-2xl transition-all transform hover:-translate-y-2 cursor-pointer">
              <div className="w-12 h-12 bg-[#1E5AA8]/10 rounded-xl flex items-center justify-center mb-4 group-hover:bg-[#F29F05]/10 transition-colors">
              ...
              <div className="flex items-center text-[#1E5AA8] font-medium group-hover:text-[#F29F05] transition-colors">
