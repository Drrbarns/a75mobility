        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {contactMethods.map((method, index) => (
            ...
            >
              ...
              <button className="w-full bg-gray-100 text-[#0B1A33] py-3 rounded-lg font-semibold hover:bg-[#0B1A33] hover:text-white transition-colors cursor-pointer whitespace-nowrap">
                {method.action}
              </button>
            </div>
          ))}
        ...
        <div className="mt-16 bg-gradient-to-r from-red-500 to-red-600 rounded-3xl p-12 text-center text-white relative overflow-hidden">
          ...
          <div className="relative z-10">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <button className="border-2 border-white text-white px-8 py-4 rounded-lg font-semibold hover:bg-white hover:text-red-600 transition-all cursor-pointer whitespace-nowrap">
                Roadside Assistance
              </button>
            </div>
          </div>
